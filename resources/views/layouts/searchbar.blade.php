<div class="relative w-full">
    <a id="ClosestSensorButton" type="button" class="absolute inset-y-0 start-0 flex items-center justify-center w-10 h-10 z-50">
    ...
    <input id="search-bar" type="search" name="search" id="search" autocomplete="false" class="z-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." required />
    <ul id="suggestions-list" class="absolute hidden left-1/2 transform -translate-x-1/2 mt-2 w-full max-h-80 overflow-y-auto border border-gray-300 bg-white rounded-lg shadow-lg z-40">
