<x-app-layout>
    ...
    <div class="py-12 flex justify-center">
        <div class="flex items-center flex-col max-w-7xl mx-auto sm:px-6 lg:px-8 w-full ">
            ...
            <x-card class="flex-col justify-center">
                <div>
                    <strong>Sensors:</strong>
                </div>
                <div>
                    <x-modal-toggle data-modal-target="create" data-modal-toggle="create">Create Sensor</x-modal-toggle>
                </div>
                <div>
                    <x-modal-toggle data-modal-target="delete" data-modal-toggle="delete">Delete Sensor</x-modal-toggle>
                </div>
            </x-card>

            <!-- Modal to create Sensor -->
            <x-modal id="create" class="bg-gray-500 bg-opacity-75 h-full">
